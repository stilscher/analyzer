...
df.plot(ax=ax, x="index_commit", y=["LOC", "Previously required evaluations / 100", "Evaluations utilizing intra-functional changes / 100"], kind="bar", width=0.7, figsize=(8,6))
df.plot(ax=ax2, x="index_commit", y=["LOC", "Previously required evaluations / 100", "Evaluations utilizing intra-functional changes / 100"], kind="bar", width=0.7, figsize=(8,6))
df.plot(ax=ax3, x="index_commit", y=["LOC", "Previously required evaluations / 100", "Evaluations utilizing intra-functional changes / 100"], kind="bar", width=0.7, figsize=(8,6))
